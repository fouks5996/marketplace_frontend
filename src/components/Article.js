...
function Article({ article, allowEdit, forceUpdate }) {
	...
	return (
		<>
			{editing && (
				<>
					<div className='flex items-center justify-center h-screen w-screen absolute z-10 top-0 bg-gray-700 opacity-75'></div>
					<div className='bg-white z-30 absolute top-[50%] left-[50%] pb-10 px-10 rounded-2xl translate-x-[-50%] translate-y-[-50%]'>
			...
			<div className='border border-black w-fit p-2 rounded-xl relative'>
				<img
					alt=''
					className=' rounded-lg mb-2 max-w-[260px]'
